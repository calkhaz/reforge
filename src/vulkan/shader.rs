...
impl Shader {
    pub fn from_path(device: &Rc<ash::Device>, path: &String) -> Result<Shader> {
    ...
    pub fn from_contents(device: &Rc<ash::Device>, name: String, shader_type: vk::ShaderStageFlags, glsl_source: String) -> Result<Shader> {
    ...
    fn create_spirv(name: &String, shader_type: shaderc::ShaderKind, glsl_source: String) -> Result<CompilationArtifact> {
